 ...
 * modif it under the terms of the GNU Lesser General Public
...
class adLDAP {
    ...
    */    
	...
	if (isset($attributes["category"])){ $mod["businessCategory"][0]=$attributes["category"]; }
	...
	if (isset($attributes["photo"])) { $mod["jpegPhoto"][0]=$attributes["photo"]; }
